...
const KIND_OPTIONS: KindOption[] = [
  ...
  { value: "keyword_overview", label: "Keyword overviews" },
  { value: "faq_research", label: "FAQ research" },
  { value: "strategy", label: "Strategy" },
  { value: "content_brief", label: "Content briefs" },
  { value: "content_copy", label: "Content copy" },
  { value: "backlinks_overview", label: "Backlinks overview" },
  { value: "backlink_prospects", label: "Backlink prospects" },
  { value: "referring_domains", label: "Referring domains" },
  { value: "backlink_trends", label: "Backlink trends" },
  { value: "outreach_drafts", label: "Outreach drafts" },
  { value: "report", label: "Reports" },
  { value: "technical_crawl", label: "Technical crawls" },
  { value: "onpage_audit", label: "On-page audits" },
  { value: "lighthouse_audit", label: "Lighthouse audits" },
  { value: "domain_overview", label: "Domain overviews" },
  { value: "organic_rankings", label: "Organic rankings" },
  { value: "competitive_analysis", label: "Competitive analysis" },
  { value: "gbp_heatmap", label: "GBP heatmaps" },
  { value: "ai_snapshot", label: "AI snapshots" },
